...
var useRadioButtons = manifest.maxChoicesPerVoter === 1;
...
var js = compiled({ seperateAuthentication: config.seperateAuthentication, randomness : config.userChosenRandomness, showOtp : config.showOtp, radioButtons: useRadioButtons});
