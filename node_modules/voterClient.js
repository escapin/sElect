...
var receiptID_LENGTH=10; // length of the verification code in case 'userProvidedRandomness' is false 
// (if this number is odd, the next even one will be taken)
// SHORTCUTS
...
exports.create = function(electionID, colServVerifKey, mixServEncKeys, mixServVerifKeys)
{
    ...
    //
    // Returns
	//  	ENC_mix1(electionID, ENC_Mix2( electionID, ... ENC_MixN(electionID, choiceMsg, verificationCode)...)
	//
	// where verificationCode ::= (TAG_VERIFCODEAUTO, receiptID) | (TAG_VERIFCODEUSER, receiptID, userCode)  
    //
    // Arguments:
    //	int      	choice
	//	string		userCode: supposed to be a 10 characters string	
    //
    // Returns:
    //   a receipt
    //
    function createBallot (choices, userCode) {
        ...
        // remove duplicates and sort choices by number
    ...
    ///
    // Check the result of the collecting server against the given
    // receipt.
    //
