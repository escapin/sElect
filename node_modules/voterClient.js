...
exports.create = function(electionID, colServVerifKey, mixServEncKeys, mixServVerifKeys)
{
    ...
    //   a receipt
    //
    function createBallot (choice, randomCode) {
        ...
        var receiptID = randomCode + crypto.nonce().slice(0,10);
    ...
    function checkColServerResult(data, receipt) {
        ...
        if (res.blame) { 
            ...
            res.blamingData = {
                ...
                signature: receipt.signature, // the signature of the collectin server
                ballot: receipt.ballot // the ballot signed by the collectin server (==ciphertexts[0])
            }
        }
        return res;
    }
