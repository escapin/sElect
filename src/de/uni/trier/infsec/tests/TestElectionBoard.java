...
public class TestElectionBoard extends TestCase
{
	...
	public Date startTime, endTime;	// milliseconds time value since January 1, 1970, 00:00:00 GMT
	...
	{
		electionID="TestElectionBoard".getBytes();
		...
		endTime=new Date(startTime.getTime() + (3600*1000)); // + 1h
	...
	public void test() throws Exception
	{
		...
		elBoard.title=title;
		elBoard.description=description;
		elBoard.headline=headline;
		elBoard.choicesList=choicesList;
		elBoard.votersList=votersList;
		elBoard.collectingServer=colServer;
		elBoard.finalServer=finServer;
		elBoard.bulletinBoardsList=bulletinBoard;
		elBoard.startTime=startTime;
		elBoard.endTime=endTime;
